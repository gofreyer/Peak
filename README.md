...
In my preliminary first C# WPF implementation for the time being and then also in the vanilla javascript web application (developed pretty much directly from the C# coding as the basis algorithm source) the game moves away from building towers to a more abstract way of adding up numbers.
